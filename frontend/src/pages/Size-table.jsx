    ...
    return (
        <div className="main-container">
            <div className='container'>
                <div className='p-5'>
                    <h2 className='text-center mt-3 mb-3 fst-italic'>Misura di taglie Maison</h2>
                </div>
                <div className='p-3'>
                ...
                <div className='table-container'>
                    ...
                    <table className=" table-color table table-bordered table-striped text-center mt-5">
                        <tbody>
                            <tr>
                                <td colSpan={8}>
                                    <strong>Misure e Vestibilità, altezza 166 - 172 cm</strong>
                                </td>
                            </tr>
                            <tr>
                                <td colSpan="2"><strong>Taglie</strong></td>
                                <td>XS</td>
                                <td>S</td>
                                <td>M</td>
                                <td>L</td>
                            ...
                            <tr>
                                <td>6</td>
                                <td> Lunghezza del braccio  (CM)</td>
                                <td>58 - 61</td>
                                <td>58 - 61</td>
                                <td>58 - 61</td>
                                <td>58 - 61</td>
